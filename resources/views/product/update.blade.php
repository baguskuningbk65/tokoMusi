                    ...
                    <form method="POST" action="{{url('/product/'.$product->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('image') is-invalid @enderror" name="image" id="productname" placeholder="Enter Product Name" min="0" max="100">
                                @error('productname')
                                <div class="invalid-feedback">
                                    {{message}}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('productdescription') is-invalid @enderror" name="productdescription" id="productprice" placeholder="Enter Product Price" min="0" max="100">
                                @error('productname')
                                <div class="invalid-feedback">
                                    {{message}}
                                </div>
